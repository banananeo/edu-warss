    ...
    <div className="calendar">
      ...
      <div className="bcard calendar__grid-card">
        ...
        <div className="calendar__legend">
          <span><i className="calendar__legend-swatch calendar__legend-swatch--working" />Working day</span>
          <span><i className="calendar__legend-swatch calendar__legend-swatch--holiday" />Holiday</span>
          <span><i className="calendar__legend-swatch calendar__legend-swatch--event" />Event</span>
        </div>
      </div>
